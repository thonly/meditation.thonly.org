...
*/
  ...
  function prepareUI() {
    ...
    registerControl("solid", readUIInt, "change");
    registerControl("division", readUIFloat, "change");
    registerControl("hole", readUIFloat, "change");
    registerControl("color", readUIFloat, "change");
    registerControl("speed", readSpeed, "change");
    readUI();
  } // prepareUI
